...
class Chat:
    def __init__(self, chat_id: ChatId, name: str, is_group_chat:bool, created_by:UserId, members:List[UserId]):
    ...
    @classmethod
    def create_new_chat(cls, name: str, is_group_chat:bool, created_by:UserId, members:List[UserId]) -> "Chat":
